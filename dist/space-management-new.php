					...
					<div class="col-lg-6 col-md-8 col-sm-8 col-xs-12 col-12">
						<form class="post-create-form" id="post-create-form" action="" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group row">
								...
								<div class="col-md-9">
									<input type="text" class="form-control datepicker" name="post-date" id="post-date" placeholder="提案日期..." >
								</div>
							</div>
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="text" name="post-content" id="post-content" class="form-control" placeholder="輸入提案內容...">
                </div>
              </div>
							<div class="form-group row">
