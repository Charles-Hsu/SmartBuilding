    ...
    <div class="sidemenu">
        <div class="sidemenu-wrapper">
            ...
            <ul class="sidemenu-nav">
                ...
                <li>
                    <a href="<?= $urlName ?>/govern.php" class="d-flex sidemenu-link align-items-center" title="政府專區" data-type="govern">
                        <i class="far fa-smile"></i>
                        <span>政府專區</span>
                    </a>
                </li>
                <li>
                    <a href="<?= $urlName ?>/system.php" class="d-flex sidemenu-link align-items-center" title="資安管理" data-type="system">
